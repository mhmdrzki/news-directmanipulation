...
<div class="container titlecolor">		
    <h3 class="title"><a style="cursor: pointer;" href="<?php echo base_url('berita')?>">Our News</a></h3>
</div>
</div>
<!-- container -->
<div class="container">				
...
<div class="news-grids" >
    ...
    <div class="col-md-4 news-grid">
        ...
        <div class="news-grid-left-info">
            <h5><a style="color: black" href="<?php echo base_url('berita/read/'.$berita->slug_berita) ?>"><?php echo $berita->nama_berita ?></a></h5>
